...
export default function ArticleCard({ article }: Props) {
  return (
    <Link href={`/column/${article.slug}`} className="block group">
      <div className="bg-card rounded-lg border border-gray-800 hover:border-accent transition-colors duration-200 p-5 h-full flex flex-col">
        ...
        <h2 className="text-sm font-bold text-gray-100 line-clamp-2 group-hover:text-accent transition-colors mb-2 leading-snug">
          {article.title}
        </h2>
