        ...
        <div className="p-6 flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <span className="bg-accent text-white text-xs font-black px-2 py-1 rounded">PICK UP</span>
          ...
          <div className="mt-4 flex items-center gap-4 flex-wrap">
            <p className="text-2xl font-black text-accent">¥{work.price.toLocaleString()}</p>
            <Link
            ...
            <Link href={`/works/${work.id}`} className="text-sm text-gray-400 hover:text-accent transition-colors">
              詳細を見る
            </Link>
          </div>
        </div>
